...
while True:
	try:
		...
		if santet == "01" or santet == "1":	
			...
			sys.exit()
			print("Telegram: @Bu_user_doim_band")
		elif santet.lower() == "Script haqida":
			print("ushbu script orqali telegram guruhlarga har bir sozni 2000 marotabadan ham koproq yubora olasiz. Bu script tuzuvchisi @Bu_user_doim_band .")
		...
		print("Telefon raqamingiz xato ekan. Qaytadan urunib ko'ring")
